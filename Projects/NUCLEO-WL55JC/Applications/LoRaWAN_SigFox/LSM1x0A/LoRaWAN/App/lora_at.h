...
/**
  * @brief  Set the Confirmed Retransmission NbTrans
  * @param  param String parameter to Confirmed_Retransmission 
  * @retval AT_OK
  */
...
/**
  * @brief  Get the Unconfirmed Retransmission NbTrans
  * @param  param String parameter to Unconfirmed_Retransmission 
  * @retval AT_OK
  */
ATEerror_t AT_Unconfirmed_Retransmission_get(const char *param);

/**
  * @brief  Set the Unconfirmed Retransmission NbTrans
  * @param  param String parameter to Unconfirmed_Retransmission 
  * @retval AT_OK
  */
...
/**
  * @brief  Start Modulation Tx test
  * @param  param String parameter
  * @retval AT_OK
  */
...
/**
  * @brief  Start Modulation Rx test
  * @param  param String parameter
  * @retval AT_OK
  */

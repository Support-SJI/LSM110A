...
extern sfx_error_t Get_encrypted_sf_data(sfx_u8 *encrypted_data, sfx_u8 *data_to_encrypt, sfx_u8 data_len);
...
ATEerror_t AT_selection_get(const char *param)
{
...
ATEerror_t AT_selection_set(const char *param)
{
...
ATEerror_t AT_fw_set(const char *param)
{
...
ATEerror_t AT_test_rl(const char *param)
{
	sfx_u8 frame[32];
	sfx_s16 rssi;
...
ATEerror_t AT_test_sl(const char *param)
{

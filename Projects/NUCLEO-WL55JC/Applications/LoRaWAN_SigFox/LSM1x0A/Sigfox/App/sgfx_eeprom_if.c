...
#if defined (__DEV_LSM100A__)
  E2P_Write(EE_SGFX_RC_ID, SFX_RC1);    /* Default RC at device birth*/
#elif defined (__DEV_LSM110A__)
  E2P_Write(EE_SGFX_RC_ID, SFX_RC2);    /* Default RC at device birth*/
#endif
...
uint8_t E2P_Read_Mode(void)
{
  ...
  return (uint8_t) SgfxMode;
  /* USER CODE BEGIN E2P_Read_Rc_2 */

  /* USER CODE END E2P_Read_Rc_2 */
}

void E2P_Write_Mode(uint8_t SgfxMode)
{
...
uint8_t E2P_FW_Read_Mode(void)
{
  ...
  /* USER CODE END E2P_Read_Rc_1 */
  uint32_t SgfxMode = 0;
  E2P_Read(EE_FW_MODE_ID, &SgfxMode);
  return (uint8_t) SgfxMode;
  /* USER CODE BEGIN E2P_Read_Rc_2 */
